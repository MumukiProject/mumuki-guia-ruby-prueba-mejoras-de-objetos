...
it("Una persona que se desempeña en la docencia es de colombia y camina 1km al día no es peripatética", function() {
  assert.equal(esPeripatetica("docente", "colombia", 1), false);
})